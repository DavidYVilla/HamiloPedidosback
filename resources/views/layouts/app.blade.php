                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ url('/verificar') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label for="telefono">Teléfono ingresado: </label>
                                            <input type="text" name="otp"
                                                value="{{ auth()->user()->telefono }}" class="form-control"
                                                placeholder="Ingresa codigo OTP..." disabled>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <a href="{{ url('reenviar') }}" class="btn btn-link">Reenviar tu codigo
                                            OTP</a>
